...
if aoi != []:
    ...
    try:
        ...
        map1.add_colormap(width=20,height=13,vis_params= vis_params,label="NDVI")#, orientation="vertical", layer_name="Median of NDVI for all selected dates", transparent_bg=True)                       
