...
if aoi != []:
    ...
    try:
        ...
        map1.add_colormap(width=10,height=0.1, vmin=0, vmax=1,vis_params= vis_params,label="NDVI", position=(20, -30),transparent=True)  #, orientation="vertical", layer_name="Median of NDVI for all selected dates", transparent_bg=True)                       
