...
if aoi != []:
    ...
    try:
        ...
        map1.add_colormap(vis_params,label="NDVI", orientation="vertical", layer_name="Median of NDVI for all selected dates", transparent_bg=True)                       
    ...
    if graph_ndvi:    
        ...
        try:
            ...
            if selected_points is not None:
                ...
                map1.add_colormap(vis_params, label="NDVI", layer_name="NDVI for "+str(clickdate), orientation="vertical", transparent_bg= False)                       
