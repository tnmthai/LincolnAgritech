...
if aoi != []:
    ...
    try:
        ...
        map1.add_colorbar(vis_params,width=12, height=0.4, label="NDVI", layer_name="Median of NDVI for all selected dates", orientation="horizontal", transparent_bg=True)                              
