...
if aoi != []:
    ...
    try:
        ...
        map1.add_colormap(width=0.1,height=0.3,vis_params= vis_params,label="NDVI")#, orientation="vertical", layer_name="Median of NDVI for all selected dates", transparent_bg=True)                       
