...
if aoi != []:
    ...
    try:
        ...
        map1.add_colormap(width=10, height=0.1, vmin=0, vmax=1,vis_params= vis_params,label="NDVI", position=(0, 0),transparent=True, tick_size=8,)  #, orientation="vertical", layer_name="Median of NDVI for all selected dates", transparent_bg=True)                       
