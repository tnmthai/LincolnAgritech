...
if aoi != []:
    ...
    try:
        ...
        map1.add_colorbar(vis_params,width=12, height=0.7, label="NDVI", orientation='horizontal', layer_name="test 1", transparent_bg= False)                              
    ...
    if graph_ndvi:    
        ...
        try:
            ...
            if selected_points is not None:
                ...
                map1.add_colorbar(vis_params, label="NDVI", layer_name="test 2", orientation="horizontal", transparent_bg= False)                       
